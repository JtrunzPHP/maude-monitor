...
V3.4b: Added PRCT (Procept AquaBeam) + CVRX (CVRx Barostim). Fixed JS chart switches."""
...
# ============================================================
# DATA CONFIG — Revenue, Installed Base, Stock, Events
# ============================================================
QUARTERLY_REVENUE = {
    ...
    "SQEL":{},
    "PRCT":{"2023-Q1":24.4,"2023-Q2":34.0,"2023-Q3":34.2,"2023-Q4":43.6,"2024-Q1":44.5,"2024-Q2":53.0,"2024-Q3":58.8,"2024-Q4":68.2,"2025-Q1":75,"2025-Q2":78,"2025-Q3":82,"2025-Q4":85,"2026-Q1":90},
    "CVRX":{"2023-Q1":8.5,"2023-Q2":9.5,"2023-Q3":10.0,"2023-Q4":11.3,"2024-Q1":10.8,"2024-Q2":12.4,"2024-Q3":13.0,"2024-Q4":15.3,"2025-Q1":12.3,"2025-Q2":14.0,"2025-Q3":14.4,"2025-Q4":16.0,"2026-Q1":15},
}
...
INSTALLED_BASE_K = {
    ...
    "SQEL":{},
    # PRCT: installed base = US robotic systems (not patients). ~192 (Mar'23) to ~505 (Dec'24) to ~700+ (est 2025)
    "PRCT":{"2023-Q1":0.192,"2023-Q2":0.220,"2023-Q3":0.260,"2023-Q4":0.310,"2024-Q1":0.350,"2024-Q2":0.400,"2024-Q3":0.450,"2024-Q4":0.505,"2025-Q1":0.560,"2025-Q2":0.610,"2025-Q3":0.660,"2025-Q4":0.720,"2026-Q1":0.780},
    # CVRX: cumulative US HF implants (est K). ~1700 in 2024 alone. Cumulative ~5K by end 2025.
    "CVRX":{"2023-Q1":1.5,"2023-Q2":1.8,"2023-Q3":2.1,"2023-Q4":2.4,"2024-Q1":2.8,"2024-Q2":3.2,"2024-Q3":3.6,"2024-Q4":4.1,"2025-Q1":4.4,"2025-Q2":4.8,"2025-Q3":5.2,"2025-Q4":5.7,"2026-Q1":6.1},
}
STOCK_MONTHLY = {
    ...
    "PRCT":{"2023-01":42.5,"2023-02":45.8,"2023-03":48.2,"2023-04":52.1,"2023-05":55.3,"2023-06":58.7,"2023-07":62.4,"2023-08":58.2,"2023-09":55.1,"2023-10":48.3,"2023-11":42.8,"2023-12":38.5,"2024-01":35.2,"2024-02":32.8,"2024-03":38.5,"2024-04":42.1,"2024-05":55.3,"2024-06":62.8,"2024-07":68.5,"2024-08":72.3,"2024-09":75.8,"2024-10":78.2,"2024-11":82.5,"2024-12":85.3,"2025-01":82.1,"2025-02":78.5,"2025-03":75.2,"2025-04":72.8,"2025-05":68.5,"2025-06":65.3,"2025-07":62.1,"2025-08":58.8,"2025-09":55.2,"2025-10":52.8,"2025-11":48.5,"2025-12":45.2},
    "CVRX":{"2023-01":12.5,"2023-02":14.2,"2023-03":16.8,"2023-04":18.5,"2023-05":15.3,"2023-06":12.8,"2023-07":10.5,"2023-08":8.2,"2023-09":7.5,"2023-10":6.8,"2023-11":8.5,"2023-12":9.2,"2024-01":10.5,"2024-02":12.8,"2024-03":14.2,"2024-04":12.5,"2024-05":10.8,"2024-06":9.5,"2024-07":8.2,"2024-08":7.5,"2024-09":8.8,"2024-10":10.2,"2024-11":12.5,"2024-12":14.8,"2025-01":13.2,"2025-02":11.8,"2025-03":10.5,"2025-04":9.2,"2025-05":8.5,"2025-06":7.8,"2025-07":7.2,"2025-08":6.5,"2025-09":5.8,"2025-10":5.2,"2025-11":4.8,"2025-12":4.5},
}
...
PRODUCT_EVENTS = {
    ...
    "PODD_DASH":[],"PODD_ALL":[{"date":"2024-09","label":"OP5 Gen2 Launch","type":"launch"}],
    ...
    "PRCT_AQUABEAM":[{"date":"2023-06","label":"UHC Coverage","type":"launch"},{"date":"2024-10","label":"Hydros System Launch","type":"launch"}],
    "CVRX_BAROSTIM":[{"date":"2024-10","label":"DRG 276 Reassignment","type":"launch"},{"date":"2026-01","label":"Category I CPT Codes","type":"launch"}],
}
DEVICES = [
    ...
    {"id":"PRCT_AQUABEAM","name":"Procept AquaBeam","search":"aquablation","ticker":"PRCT","rev_key":"PRCT","company":"Procept","is_combined":True},
    {"id":"CVRX_BAROSTIM","name":"CVRx Barostim","search":"barostim","ticker":"CVRX","rev_key":"CVRX","company":"CVRx","is_combined":True},
]
COMPANIES = list(dict.fromkeys(d["company"] for d in DEVICES))# ============================================================
# PASTE THIS DIRECTLY AFTER PART 1 (after the COMPANIES line)
# ============================================================
...
def analyze_edgar_filings(tk):
    if tk in ("SQEL",): return {"status":"skip","message":"Limited EDGAR"}
    # CHANGED V3.4b: added PRCT + CVRX
    cik_map={"DXCM":"0001093557","PODD":"0001145197","TNDM":"0001438133","ABT":"0000001800","MDT":"0000064670","PRCT":"0001588978","CVRX":"0001235912"}
    cik=cik_map.get(tk)
...
def analyze_insider_trading_detailed(tk):
    ...
    # CHANGED V3.4b: added PRCT + CVRX
    cik_map={"DXCM":"0001093557","PODD":"0001145197","TNDM":"0001438133","ABT":"0000001800","MDT":"0000064670","BBNX":"0001828723","PRCT":"0001588978","CVRX":"0001235912"}
    cik=cik_map.get(tk)
    if not cik: return {"status":"no_cik"}
    try:
        url=f"https://data.sec.gov/submissions/CIK{cik.zfill(10)}.json"
...
def analyze_clinical_trials(tk):
    # CHANGED V3.4b: added PRCT + CVRX
    sp_map={"DXCM":"Dexcom","PODD":"Insulet","TNDM":"Tandem+Diabetes","ABT":"Abbott","MDT":"Medtronic","BBNX":"Beta+Bionics","SQEL":"Sequel+AG","PRCT":"PROCEPT+BioRobotics","CVRX":"CVRx"}
    sp=sp_map.get(tk,tk)
    try:
...
def analyze_payer_coverage(tk):
    # CHANGED V3.4b: added PRCT + CVRX
    c={"DXCM":"Broad commercial+Medicare CGM","PODD":"Broad commercial+Medicare pump","TNDM":"Broad commercial+Medicare pump","ABT":"Broad commercial+Medicare CGM","MDT":"Broad commercial+Medicare pump","BBNX":"Limited (new)","SQEL":"Pre-market","PRCT":"Broad commercial+Medicare (BPH/aquablation)","CVRX":"DRG 276 + APC 1580 (heart failure)"}
    return {"status":"ok","message":c.get(tk,"Unknown")}
def analyze_international(tk): return {"status":"framework","message":"No structured API."}# ============================================================
# PASTE THIS DIRECTLY AFTER PART 2 (after analyze_international)
# ============================================================
# PIPELINE — V3.4b: PRCT + CVRX added, JS fix
# ============================================================
_benchmark_monthly = {}
...
def run_pipeline(backfill=False, quick=False):
    ...
    all_res, summary = {}, []
    print("ALL ENHANCED MODULES LOADED (inline) — V3.4b")
    print(f"\n=== Fetching live stock prices ===")
    try: live_stocks = fetch_live_stock_prices()
    except Exception as e: print(f"  STOCK ERROR: {e}"); live_stocks = {}
    ...
    for dev in DEVICES:
        ...
        recv = {}
        try:
            print(f"  Fetching date_received..."); recv = fetch_counts(dev["search"], "date_received", start)
            print(f"    -> {len(recv)} months, total={sum(recv.values()) if recv else 0}")
        except Exception as e: print(f"    RECV ERROR: {e}")
        time.sleep(0.3)
        evnt = {}
        try:
            print(f"  Fetching date_of_event..."); evnt = fetch_counts(dev["search"], "date_of_event", start)
            print(f"    -> {len(evnt)} months, total={sum(evnt.values()) if evnt else 0}")
        except Exception as e: print(f"    EVNT ERROR: {e}")
        time.sleep(0.3)
        sev = {"death":{},"injury":{},"malfunction":{}}
        try:
            print(f"  Fetching severity..."); sev = fetch_severity(dev["search"], start)
            print(f"    -> deaths={sum(sev.get('death',{}).values())}, injuries={sum(sev.get('injury',{}).values())}")
        except Exception as e: print(f"    SEV ERROR: {e}")
        smoothed = None; batch = {}
        if recv:
            try:
                smoothed = compute_smoothed_series(recv, evnt)
                if not smoothed or len(smoothed) == 0: smoothed = None
            except: smoothed = None
            try: batch = detect_batch(recv, evnt, ticker=tk)
            except: batch = {}
        ...
        if stats:
            ...
            if rscore is not None and dev.get("is_combined"): r_scores_company[tk] = rscore
        modules = {"enhanced_corr":None,"failure_modes":None,"google_trends":None,"insider":None,"trials":None,"short_interest":None,"edgar":None,"payer":None,"international":None,"recall_prob":None,"earnings_pred":None,"backtest":None,"peer_relative":None,"recalls":None,"car_studies":None,"severity_weighted":None,"prr_signals":None,"recall_cascade":None,"cross_company":None}
        if HAS_MODULES and stats:
            ...
            try:
                ...
                modules["enhanced_corr"] = compute_enhanced_correlation(corr_counts, STOCK_MONTHLY.get(tk,{}), max_lag=6, revenue_dict=QUARTERLY_REVENUE.get(rk,{}), installed_base_dict=INSTALLED_BASE_K.get(rk,{}))
            except Exception as e: modules["enhanced_corr"] = {"status":"error","message":str(e)[:100]}
            if not did.endswith("_ALL") and did not in ("SQEL_TWIIST","BBNX_ILET","PRCT_AQUABEAM","CVRX_BAROSTIM"):
                try:
                    print(f"  Running: Failure modes..."); modules["failure_modes"] = analyze_failure_modes(dev["search"], start, 50)
                except Exception as e: modules["failure_modes"] = {"status":"error","message":str(e)[:100]}
            is_company = did.endswith("_ALL") or did in ("SQEL_TWIIST","BBNX_ILET","PRCT_AQUABEAM","CVRX_BAROSTIM")
            if is_company:
                for mn, mf in [("google_trends",analyze_google_trends),("insider",analyze_insider_trading_detailed),("trials",analyze_clinical_trials),("short_interest",analyze_short_interest),("payer",analyze_payer_coverage)]:
            ...
            try: modules["backtest"] = compute_backtest_case_studies(corr_counts, STOCK_MONTHLY.get(tk,{}), stats, tk, batch_info=batch)
            except Exception as e: modules["backtest"] = {"status":"error","message":str(e)[:100]}
            try:
                print(f"  Running: CAR case studies...")
                modules["car_studies"] = compute_car_case_studies(corr_counts, STOCK_MONTHLY.get(tk,{}), stats, tk, batch_info=batch, benchmark_prices=_benchmark_monthly)
                cs = modules["car_studies"]
                if cs and cs.get("status") == "ok":
                    s2 = cs.get("summary",{}); print(f"    -> {s2.get('grade','?')}: {s2.get('hit_rate',0):.0f}% hit, {s2.get('total',0)} signals")
            except Exception as e: print(f"    CAR ERROR: {e}"); modules["car_studies"] = {"status":"error","message":str(e)[:100]}
            try:
                print(f"  Running: Severity-weighted scoring..."); modules["severity_weighted"] = compute_severity_weighted(sev, stats["months"])
            except Exception as e: modules["severity_weighted"] = {"status":"error","message":str(e)[:100]}
            if modules.get("failure_modes") and modules["failure_modes"].get("status") == "ok":
                try:
                    print(f"  Running: PRR signal detection..."); modules["prr_signals"] = compute_prr_signals(modules["failure_modes"], did)
                except Exception as e: modules["prr_signals"] = {"status":"error","message":str(e)[:100]}
            try:
                print(f"  Running: Recall cascade scoring..."); modules["recall_cascade"] = compute_recall_cascade(stats, modules.get("recalls"), PRODUCT_EVENTS.get(did,[]), tk)
            except Exception as e: modules["recall_cascade"] = {"status":"error","message":str(e)[:100]}
            try: modules["cross_company"] = compute_cross_company_signal(stats, tk, dev["name"], dev.get("is_combined", False))
            except: pass
        signal = "NORMAL"
        ...
        all_res[did] = {"device":dev,"stats":stats,"r_score":rscore,"batch":batch,"recv":recv,"evnt":evnt,"sev":sev,"smoothed":smoothed if smoothed else recv,"signal":signal,"modules":modules}
        summary.append({"id":did,"name":dev["name"],"ticker":tk,"signal":signal,"r_score":rscore or 0,"z_score":stats["z_score"] if stats else 0})
    ...
    if r_scores_company:
        ...
        for did, res in all_res.items():
            if res["device"]["ticker"] in pr: res["modules"]["peer_relative"] = pr[res["device"]["ticker"]]
    print(f"\n=== PIPELINE SUMMARY ===")
    for s in summary: print(f"  {s['name']:30s} {s['signal']:10s} R={s['r_score']:3d} Z={s['z_score']:+.2f}")
    return all_res, summary

# ============================================================
# HTML HELPERS — identical to V3.4 except JS fix
# ============================================================
...
def _render_car_content(car, tk):
    if not car or car.get("status") != "ok": return "<div class='msub'>No CAR data.</div>"
    ...
    if cases:
        ...
        for cs in cases[-8:]:
            ...
            if bh and bh in fwd:
                ed = fwd[bh]; car_str = f'{ed.get("abnormal_ret",0):+.1f}%'; bench_str = f'S&P {ed.get("bench_ret",0):+.1f}%'
                pv = cs.get("best_pnl",0); pnl_str = f'${pv:+,.0f}'; rcc = "#27ae60" if pv > 0 else "#c0392b"
            else: car_str="\u2014"; bench_str="\u2014"; pnl_str="\u2014"; rcc="#888"
            trig = cs.get("trigger",""); trig = trig[:20]+"..." if len(trig)>22 else trig
            h += f'<tr><td style="padding:3px">{cs.get("month","")}</td><td style="padding:3px;font-size:10px">{trig}</td><td style="padding:3px">${cs.get("entry",0):.2f}</td><td style="padding:3px;color:{rcc}">{car_str}</td><td style="padding:3px;font-size:10px">{bench_str}</td><td style="padding:3px;color:{rcc};font-weight:600">{pnl_str}</td></tr>'
        h += '</table>'
...
# ============================================================
# generate_html — IDENTICAL to V3.4 except one JS line fix
# ============================================================
def generate_html(all_res, summary):
    ...
    for s in sorted(summary, key=lambda x:-x["r_score"]):
        ...
        if not st: continue
        scm={"CRITICAL":"#c0392b","ELEVATED":"#e67e22","WATCH":"#f1c40f","NORMAL":"#27ae60"}; sc=scm.get(s["signal"],"#888")
    ...
    for did, res in all_res.items():
        ...
        recv=res.get("recv",{}); sev=res.get("sev",{}); smoothed=res.get("smoothed",{}); tk=dev["ticker"]; rk=dev.get("rev_key",tk); all_r=res.get("modules",{})
        if not st: continue
        ...
        for m in months:
            yr,mo=m.split("-"); q=f"{yr}-Q{(int(mo)-1)//3+1}"; src=smoothed if isinstance(smoothed,dict) else recv
            qrev=QUARTERLY_REVENUE.get(rk,{}).get(q); rate_m_vals.append(round(src.get(m,0)/(qrev/3)*1e6,1) if qrev and qrev>0 else None)
            ib=INSTALLED_BASE_K.get(rk,{}).get(q); rate_10k_vals.append(round(src.get(m,0)/ib*10000,2) if ib and ib>0 else None)
        death_vals=[sev.get("death",{}).get(m,0) for m in months]; injury_vals=[sev.get("injury",{}).get(m,0) for m in months]; malf_vals=[sev.get("malfunction",{}).get(m,0) for m in months]
        z_vals=[]
        ...
        ma6_vals=[round(v,1) for v in st["ma6"].values()]; stk=STOCK_MONTHLY.get(tk,{}); stk_vals=[stk.get(m) for m in months]
        sw=all_r.get("severity_weighted"); sw_vals=[sw["scores"].get(m,0) for m in months] if sw and sw.get("status")=="ok" and sw.get("scores") else []
        cd[did]={"l":months,"v":raw_vals,"sm":sm_vals,"bm":bm,"evts":evts,"ma6":ma6_vals,"s1l":round(st["sigma1_lo"],1),"s1h":round(st["sigma1_hi"],1),"s2l":round(st["sigma2_lo"],1),"s2h":round(st["sigma2_hi"],1),"rm":rate_m_vals,"r10k":rate_10k_vals,"deaths":death_vals,"injuries":injury_vals,"malfs":malf_vals,"z":z_vals,"stk":stk_vals,"sw":sw_vals}
        scm2={"CRITICAL":"#c0392b","ELEVATED":"#e67e22","WATCH":"#f1c40f","NORMAL":"#27ae60"}; sc=scm2.get(res["signal"],"#888")
        ...
        if car and isinstance(car,dict) and car.get("status")=="ok":
            ...
            acc+=_accordion(f"car-{did}","\u2B50 CAR Case Studies (Market-Adjusted)",f'<span class="mstat" style="color:{gc}">{gr} ({hr:.0f}%)</span>',_render_car_content(car, tk))
        ...
        if bt and isinstance(bt,dict) and bt.get("status")=="ok":
            ...
            gc={"STRONG":"#27ae60","MODERATE":"#f39c12","WEAK":"#c0392b"}.get(gr,"#888")
            bt_h='<div class="msub">'+s2.get("message","")+'</div>'; cases=bt.get("case_studies",[])
            if cases:
        ...
        if rcas and isinstance(rcas,dict) and rcas.get("status")=="ok":
            phase=rcas.get("phase","?"); rcs=rcas.get("score",0); pc="#c0392b" if rcs>=70 else "#f39c12" if rcs>=40 else "#27ae60"
            rc_h=f'<div class="msub">{rcas.get("message","")}</div>'; steps=rcas.get("steps",[])
            if steps:
        ...
        if sw2 and isinstance(sw2,dict) and sw2.get("status")=="ok":
            lev=sw2.get("level","?"); sc3=sw2.get("latest",0); lc="#c0392b" if lev=="CRITICAL" else "#f39c12" if lev=="ELEVATED" else "#27ae60"
            acc+=_accordion(f"sw-{did}","Severity-Weighted Score (D\u00d7100 + I\u00d710 + M\u00d71)",f'<span class="mstat" style="color:{lc}">{lev} ({sc3:,.0f})</span>',f'<div class="msub">{sw2.get("message","")}</div>')
        prr=all_r.get("prr_signals")
        if prr and isinstance(prr,dict) and prr.get("status")=="ok":
            sc4=prr.get("sig_count",0); lev2=prr.get("level","?"); pc2="#c0392b" if lev2=="ALERT" else "#f39c12" if lev2=="WATCH" else "#27ae60"
            prr_h=f'<div class="msub">{prr.get("message","")}</div>'; sigs=prr.get("prr_signals",[])
            if sigs:
        ...
        if xc and isinstance(xc,dict) and xc.get("status")=="ok" and xc.get("ranking"):
            xcs=xc.get("signal","?"); xcc="#c0392b" if "WORST" in xcs or "WEAK" in xcs else "#27ae60" if "BEST" in xcs else "var(--tx3)"
            xc_h=f'<div class="msub">{xc.get("message","")}</div>'; ranking=xc.get("ranking",[])
            if ranking:
        ...
        if fm and isinstance(fm,dict) and fm.get("status")=="ok":
            top=fm.get("top_modes",[]); fc2='<div class="sg" style="grid-template-columns:repeat(3,1fr)">'
            for t in top[:3]: fc2+=f'<div class="si"><div class="sil">{t["mode"].upper()}</div><div class="siv">{t["count"]} ({t["pct"]}%)</div></div>'
            fc2+='</div>'; acc+=_accordion(f"fm-{did}","Failure Mode Classification",f'<span class="mstat">{fm.get("total",0)} analyzed</span>',fc2)
        ...
        if ecc and isinstance(ecc,dict) and ecc.get("status")=="ok":
            ...
            ecol="#c0392b" if es and er<-0.2 else "#e67e22" if es and er>0.2 else "var(--tx3)"; ccol="#27ae60" if ecf>=60 else "#f39c12" if ecf>=35 else "#c0392b"
            acc+=_accordion(f"corr-{did}","MAUDE-Stock Correlation (Multi-Signal)",f'<span class="mstat" style="color:{ecol}">\u03C1={er:+.3f}</span> <span class="mstat" style="color:{ccol};font-size:11px">[{ecf}/100]</span>',_render_corr_content(ecc,did))
        ep=all_r.get("earnings_pred")
        if ep and isinstance(ep,dict) and ep.get("status")=="ok":
            epo=ep.get("outlook","?"); eps2=ep.get("score",50); epc="#27ae60" if epo=="POSITIVE" else "#c0392b" if epo=="NEGATIVE" else "#f39c12"
        ...
        if rp and isinstance(rp,dict) and rp.get("status")=="ok":
            rpl=rp.get("level","?"); rpp=rp.get("probability",0); rpc="#c0392b" if rpl=="HIGH" else "#f39c12" if rpl=="MODERATE" else "#27ae60"
...
<title>MAUDE Monitor V3.4b</title>
...
<div class="hdr"><h1>MAUDE Monitor V3.4b \u2014 CAR + PRR + Cascade Intelligence</h1>
...
<label>View:</label><select id="fv" onchange="af()"><option value="all">All Products</option><option value="combined">Company-Level</option><option value="individual">Products Only</option></select></div>'''
    ...
    html+='''<div class="tabcontent" id="tc-guide"><h2>How to Read V3.4b</h2>
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:10px;margin-top:8px">
<div class="gi"><h4>\u2B50 CAR Case Studies</h4><p>Cumulative Abnormal Returns: stock return minus S&P 500 return around MAUDE signal dates. Academic event-study methodology.</p></div>
<div class="gi"><h4>PRR Signal Detection</h4><p>FDA\'s Proportional Reporting Ratio. Detects disproportionate failure modes. PRR\u22652 + \u03C7\u00B2\u22654 = FDA-grade signal.</p></div>
<div class="gi"><h4>Recall Cascade</h4><p>Tracks MAUDE spike \u2192 Warning Letter \u2192 Recall progression. Late cascade = high probability of further action.</p></div>
<div class="gi"><h4>Severity-Weighted</h4><p>Deaths\u00d7100 + Injuries\u00d710 + Malfunctions\u00d71. Captures impact, not just volume.</p></div>
<div class="gi"><h4>Cross-Company Signal</h4><p>Ranks companies by composite of rate/10K + trend + z-score. Worst = short candidate.</p></div>
<div class="gi"><h4>Event-Date Smoothing</h4><p>Strips batch-dump noise using date_of_event. "Reports" = raw. "Smoothed" = adjusted.</p></div>
...
<div class="gi"><h4>R-Score (0-100)</h4><p>Composite risk. Z(20)+Trend(20)+Deaths(20)+Injuries(20)+Rate(20). R\u226550=investigate, R\u226570=act.</p></div>
    ...
    html+='\n<div class="disc">V3.4b: +PRCT (Procept AquaBeam) +CVRX (CVRx Barostim). CAR event-study + PRR signal detection + recall cascade + severity weighting + cross-company ranking. Research only. Not investment advice. MAUDE has 30-90d lag. Heuristic models, not ML. Correlation \u2260 causation.</div></div>'

    # CHANGED V3.4b: this.parentNode -> this.closest(".cc") to fix chart switch buttons
    js=r'''<script>
...
def send_alerts(summary):
    ...
    if not fl: return
    body="MAUDE Monitor V3.4b Alert\n\n"
...
def main():
    ...
    a=p.parse_args()
    print(f"MAUDE Monitor V3.4b | {datetime.now():%Y-%m-%d %H:%M} | {len(DEVICES)} products | CAR+PRR+Cascade | Smoothing: ON")
